          ...
          <div class="navbar-inner">
            <div class="container">       
              ...
              <div class="right-bar nav-collapse collapse">
                <div class="contact-right"><a class="button-top" target="_blank" href="https://twitter.com/harvardmun"><i class="icon-twitter button"></i></a>&nbsp;&nbsp;<a class="button-top" target="_blank" href="https://www.facebook.com/harvardmun"><i class="icon-facebook button"></i></a></div>
      ...
      <div class="navbar-inner">
        <div class="container">
          <ul class="nav">
            ...
            <li class="top-bar"><a href="http://www.hmunchina.org/" target="_blank">HMUN CHINA</a></li>
            <li class="top-bar"><a href="http://hmunindia.org/" target="_blank">HMUN INDIA</a></li>
      ...
      <div class="container spirit">
        <div class="home-span">
          <div class="section-narrow">
            ...
            <hr class="spirit"/>
            <h5><a href="http://munbase.harvardmun.org/" target="_blank">LOGIN HERE</a></h5>
            <hr class="spirit"> 
          </div>
...
<p>Whether you have attended HMUN for years or are considering participating for the first time, I strongly encourage you to submit an application. Until then, please do not hesitate to contact us with any questions, comments, or concerns. HMUN is an exciting educational opportunity, and I sincerely hope that you will choose to take part in it.</p>
      ...
      <div class="footer-bar">
        ...
        <i>Designed by <a class="no-red" href="http://lfreitas.com" target="_blank">Lucas F.</a> and Eva S.</i><br/>
        <i>Coded by <a class="no-red" href="http://lfreitas.com" target="_blank">Lucas F.</a>, Gabriel G., and Michael G.</i>
